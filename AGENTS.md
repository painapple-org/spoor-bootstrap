...
- [`skills/`](./skills/README.md) — portable, harness-agnostic skill
  ...
  `.opencode/skills/` are symlinks back into this directory so Claude
  Code and OpenCode can each discover the same skills natively — see
  [`skills/README.md`](./skills/README.md) for how that's wired.
